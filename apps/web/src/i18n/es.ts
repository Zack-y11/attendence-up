...
export const es: typeof en = {
  ...
  classDetail: {
    ...
    attendanceHintOmitted:
      'Presente y tarde cuentan como asistencia. Se usan {{count}} sesiones cerradas. Una sesión justificada queda fuera del total de ese estudiante. El nombre es el del último registro.',
    attendanceHintCounted:
      'Presente y tarde cuentan como asistencia. Se usan {{count}} sesiones cerradas. Una sesión justificada permanece en el total y no cuenta como asistencia. El nombre es el del último registro.',
    emptyAttendance: 'Todavía ningún estudiante se ha registrado en esta clase.',
    loadingAttendance: 'Cargando asistencia',
    nameLastSeen: 'Nombre del último registro',
